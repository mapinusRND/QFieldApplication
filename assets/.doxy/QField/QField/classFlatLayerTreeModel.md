...
|  Q\_INVOKABLE bool | [**hasCollapsibleItems**](#function-hascollapsibleitems) () const<br>_Returns true if the layer tree has at least one collapsible item._  |
|  Q\_INVOKABLE bool | [**isAllCollapsed**](#function-isallcollapsed) () const<br>_Returns true if all collapsible items are currently collapsed._  |
...
```C++
Q_INVOKABLE bool FlatLayerTreeModel::hasCollapsibleItems () const
```
...
```C++
Q_INVOKABLE bool FlatLayerTreeModel::isAllCollapsed () const
```
