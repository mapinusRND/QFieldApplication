...
|  Q\_INVOKABLE QgsRectangle | [**nodeExtent**](#function-nodeextent) (const QModelIndex & index, [**QgsQuickMapSettings**](classQgsQuickMapSettings.md) \* mapSettings, const float buffer) <br>_Calculate layer tree node extent and add optional buffer._  |
...
```C++
Q_INVOKABLE void FlatLayerTreeModelBase::setAllCollapsed (
    bool collapsed
) 
```
